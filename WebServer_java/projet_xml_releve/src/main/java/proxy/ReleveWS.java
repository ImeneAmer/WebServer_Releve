 ...
 * 
 */
@WebServiceClient(name = "releveWS", targetNamespace = "http://relevewsdl/", wsdlLocation = "http://localhost:9191/releve?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RELEVEWS_QNAME = new QName("http://relevewsdl/", "releveWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9191/releve?wsdl");
     ...
     * 
     * @return
     *     returns WebServerReleve
     */
    @WebEndpoint(name = "WebServerRelevePort")
    public WebServerReleve getWebServerRelevePort() {
        return super.getPort(new QName("http://relevewsdl/", "WebServerRelevePort"), WebServerReleve.class);
    }
     ...
     */
    @WebEndpoint(name = "WebServerRelevePort")
    public WebServerReleve getWebServerRelevePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://relevewsdl/", "WebServerRelevePort"), WebServerReleve.class, features);
    }
