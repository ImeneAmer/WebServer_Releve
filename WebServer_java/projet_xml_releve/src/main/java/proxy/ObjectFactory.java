...
public class ObjectFactory {
    ...
    private final static QName _Exception_QNAME = new QName("http://relevewsdl/", "Exception");
    private final static QName _GetReleve_QNAME = new QName("http://relevewsdl/", "getReleve");
    private final static QName _GetReleveResponse_QNAME = new QName("http://relevewsdl/", "getReleveResponse");
    private final static QName _Releve_QNAME = new QName("http://relevewsdl/", "releve");
     ...
     */
    @XmlElementDecl(namespace = "http://relevewsdl/", name = "Exception")
     ...
     */
    @XmlElementDecl(namespace = "http://relevewsdl/", name = "getReleve")
     ...
     */
    @XmlElementDecl(namespace = "http://relevewsdl/", name = "getReleveResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://relevewsdl/", name = "releve")
